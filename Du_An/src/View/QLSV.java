...
public class QLSV extends javax.swing.JFrame {
    ...
    public void showData() {
        ...
        txtMaSV.setText(model.getValueAt(index, 1).toString());
        txtHoten.setText(model.getValueAt(index, 3).toString());
        txtLop.setText(model.getValueAt(index, 2).toString());
        ...
        updateHinh(tblSinhVien.getValueAt(index, 8).toString());
    ...
    public PersonModel readForm() { 
            ...
            ps.setMa(txtMaSV.getText());
            ps.setLop(txtLop.getText());
