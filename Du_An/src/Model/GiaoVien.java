 ...
 * @author Dell
 */
public class GiaoVien extends PersonModel {
    private String mon;

    public GiaoVien() {
    }

    public GiaoVien(String ID, String ma, String hoTen, String lop, String mon, String email, String SDT, boolean gioiTinh, String diaChi, String hinh) {
        super(ID, ma, hoTen, lop, mon, email, SDT, gioiTinh, diaChi, hinh);
    }

    public GiaoVien(String mon) {
        this.mon = mon;
    }
